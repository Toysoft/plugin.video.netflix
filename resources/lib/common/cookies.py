...
def save(account_hash, cookie_jar):
    ...
    try:
        #pickle.dump(cookie_jar, cookie_file, protocol=pickle.HIGHEST_PROTOCOL)
        cookie_file.write(bytearray(pickle.dumps(cookie_jar, protocol=pickle.HIGHEST_PROTOCOL)))
